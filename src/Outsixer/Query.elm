...
module Outsixer.Query exposing (..)
...
-}
game : (GameOptionalArguments -> GameOptionalArguments) -> SelectionSet decodesTo Outsixer.Object.Game -> SelectionSet (List decodesTo) RootQuery
...
-}
game_aggregate : (GameAggregateOptionalArguments -> GameAggregateOptionalArguments) -> SelectionSet decodesTo Outsixer.Object.Game_aggregate -> SelectionSet decodesTo RootQuery
...
-}
game_by_pk : GameByPkRequiredArguments -> SelectionSet decodesTo Outsixer.Object.Game -> SelectionSet (Maybe decodesTo) RootQuery
...
-}
player : (PlayerOptionalArguments -> PlayerOptionalArguments) -> SelectionSet decodesTo Outsixer.Object.Player -> SelectionSet (List decodesTo) RootQuery
...
-}
player_aggregate : (PlayerAggregateOptionalArguments -> PlayerAggregateOptionalArguments) -> SelectionSet decodesTo Outsixer.Object.Player_aggregate -> SelectionSet decodesTo RootQuery
...
-}
player_by_pk : PlayerByPkRequiredArguments -> SelectionSet decodesTo Outsixer.Object.Player -> SelectionSet (Maybe decodesTo) RootQuery
